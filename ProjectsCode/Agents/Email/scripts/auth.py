#!/usr/bin/env python3
"""OAuth token management for Gmail API scripts.
...
Usage:
    ...
    service = get_gmail_service('victor@verifiedmetrics.com')
"""

# Suppress ALL warnings before any imports (especially pkg_resources/importlib.metadata)
import warnings
